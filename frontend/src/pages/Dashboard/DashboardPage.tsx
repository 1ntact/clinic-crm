...
export const DashboardPage = () => {
  ...
  const appointmentsToday = useAppSelector(state=>state.appointment.appointments)
  ...
  return (
    <>
      ...
      <div className=" h-[352px] mt-2 grid grid-cols-1 gap-2 lg:grid-cols-[0.8fr_1.25fr]">
        {roundedDiagram && (
          <RoundedDiagram  info={roundedDiagram}
      ...
      <div className="w-full min-h-[380px] mt-[8px] p-[16px] rounded-[8px] bg-[#FFFFFF] ">
        <div className="flex justify-between mb-[16px]">
          <span className="text-[14px] font-medium text-[#374151]" >APPOINTMENTS TODAY</span>
          <span className="text-[14px] text-[#2563EB] cursor-pointer"
         onClick={() => navigate("/appointments")}  >View all &gt;</span></div> 
                    <Table>
                      <thead>
